...
/// <summary>
/// Picker mínimo de color: swatch + HEX + 3 sliders R/G/B. Port a Avalonia:
/// System.Windows.Media → Avalonia.Media; ColorConverter → Color.Parse;
/// eventos de Slider/TextBox con los args de Avalonia.
/// </summary>
