...
public sealed class CargasCombinacionesViewModel : INotifyPropertyChanged
{
    ...
    private readonly CollectionViewSource _vistaServicio;
    private readonly CollectionViewSource _vistaUltimas;
    ...
    public CargasCombinacionesViewModel(Proyecto proyecto, Action pushUndoSnapshot)
    {
        ...
        _vistaServicio = new CollectionViewSource { Source = Combinaciones };
        _vistaServicio.Filter += (_, e) =>
            e.Accepted = e.Item is CombinacionCarga c && c.Tipo == TipoCombinacion.Servicio;
        _vistaUltimas = new CollectionViewSource { Source = Combinaciones };
        _vistaUltimas.Filter += (_, e) =>
            e.Accepted = e.Item is CombinacionCarga c && c.Tipo == TipoCombinacion.Ultima;
    ...
    public ICollectionView CombinacionesServicio => _vistaServicio.View;

    /// <summary>Combinaciones últimas — pestaña «Últimas» de la matriz.</summary>
    public ICollectionView CombinacionesUltimas => _vistaUltimas.View;
    ...
    {
        _vistaServicio.View?.Refresh();
        _vistaUltimas.View?.Refresh();
    }
