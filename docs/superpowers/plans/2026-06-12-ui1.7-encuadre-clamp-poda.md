...
- [x] **Step 2.1: Escribir los tests del fit (fallan)**
...
- [x] **Step 2.2: Verificar que fallan por compilación**
...
- [x] **Step 2.3: Implementar `CalcularEncuadre`**
...
- [x] **Step 3.1: Seam de tests — `internal set` + InternalsVisibleTo**
...
- [x] **Step 3.2: Escribir los tests del clamp (fallan)**
...
- [x] **Step 3.3: Verificar que los nuevos fallan**
...
- [x] **Step 3.4: Implementar el clamp**
...
- [x] **Step 4.1: Métodos de encuadre en `PlantaCanvas`**
...
- [x] **Step 4.2: Auto-encuadre en los setters de underlay**
...
- [x] **Step 4.3: Botón en la toolbar**
...
- [x] **Step 5.1: Reescribir `CaptureCanvasPng`**
...
- [x] **Step 6.1: Reordenar las pasadas**
...
- [x] **Step 7.1: Borrar el engine huérfano y sus tests**

```bash
git rm src.Core/Services/SnappingEngine.cs tests/LosasPlus.Tests/Services/SnappingEngineTests.cs
```

- [x] **Step 7.2: Verificar verde (la suite baja exactamente 22)**
...
- [x] **Step 7.3: Estampar el tablero**
...
- [x] **Step 7.4: Re-estampar STATE y commit final**
...
- [x] `git log --oneline -7` muestra los 7 commits de las tareas.
- [x] Suite final: **1209** (1207 + 24 nuevos − 22 podados) — el número exacto queda estampado en `STATE.md`.
- [ ] Queda pendiente el **gate humano** (pase visual corto post-UI1.7) — NO marcarlo: es del usuario.
- [x] NO push: `origin/main` es historia no relacionada (línea WPF vieja); master vive solo local.
